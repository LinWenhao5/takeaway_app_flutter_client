...
class _StringsOrderHistoryNl implements _StringsOrderHistoryEn {
	...
	// Translations
	@override String get orderHistory => 'Bestelgeschiedenis';
	@override String get reserved => 'Gereseveerde bestellingen';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'orderHistory.reserved': return 'Reserved Orders';
...
extension on _StringsNl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'orderHistory.reserved': return 'Gereseveerde bestellingen';
